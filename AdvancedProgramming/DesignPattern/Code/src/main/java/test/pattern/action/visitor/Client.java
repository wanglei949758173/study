...
import test.pattern.action.visitor.impl.Approve;
import test.pattern.action.visitor.impl.Audience;
import test.pattern.action.visitor.impl.NoVote;
import test.pattern.action.visitor.impl.Oppose;
