 ...
 * 编写日期 2021年04月15日 
 */
package com.wl.study.chapter10.loandemo.version3;
...
public class SharePie {
	...
	public Map<Company, Double> getRates() {
		return rates;
	}
	 ...
	 * @return				每个出借者获得的钱
	 */
	public Map<Company, Share> prorate(Money paymentMoney) {
	 ...
	 */
	public void increase(Map<Company, Share> loanShares) {
